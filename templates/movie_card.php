...
<div class="card movie-card">
    ...
    <div class="card-body">
        ...
        <a href="<?= $BASE_URL ?>movie.php?id=<?= $movie->id ?>" class="btn btn-primary rate-btn">Avaliar Filme</a>
        <a href="<?= $BASE_URL ?>movie.php?id=<?= $movie->id ?>" class="btn card-btn">Conheça o filme!</a>
    </div>
</div>